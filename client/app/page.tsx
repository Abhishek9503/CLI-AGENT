...
export default function Home() {
  ...
  // Move client-side navigation into useEffect to avoid navigations during render
  useEffect(() => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-background font-sans">
      <div className="w-full max-w-md px-4">
        <div className="space-y-8">
          {/* Profile Header Card */}
          <div className="border-2  border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900 backdrop-blur-sm">
            {/* Avatar */}
          ...
          {/* User Details Card */}
          <div className="border-2 border-dashed  border-zinc-700 rounded-2xl p-6 bg-zinc-900/90 backdrop-blur-sm space-y-4">
            <div>
